...
|----|-----------|:----:|:------:|:-----:|---------------|
| R-01 | Export endpoint zonder autorisatiecontrole (IDOR) | 4 | 5 | 20 | 🔴 Kritiek |
| R-02 | `showForm()` zonder toegangscontrole | 4 | 4 | 16 | 🔴 Kritiek |
| R-03 | Ontbrekende/incorrecte privilege-registratie | 3 | 3 | 9 | 🟡 Toezicht |
| R-04 | Default auditingStrategy = NONE | 4 | 4 | 16 | 🔴 Kritiek |
| R-05 | READ-acties niet gelogd in auditmechanisme | 4 | 4 | 16 | 🔴 Kritiek |
