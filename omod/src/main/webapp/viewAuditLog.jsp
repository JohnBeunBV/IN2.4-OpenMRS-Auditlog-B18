...
<openmrs:require privilege="View Audit Log" otherwise="/login.htm" redirect="/module/auditlog/viewAuditLog.htm" />
...
<%-- Filter bar pre-populated from URL parameter --%>
<%-- VULNERABILITY: XSS - param.userFilter rendered without escaping --%>
<c:if test="">
  <p>Filtering by user: </p>
</c:if>
